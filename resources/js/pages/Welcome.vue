...
const skills = [
  { name: 'Frontend Development', icon: Code, description: 'Vue.js, React, TypeScript, TailwindCSS' },
...
const featuredProjects = [
  {
    ...
    description: 'Modern e-commerce solution with Vue.js and Laravel backend',
    image: '/images/project1.jpg',
    tech: ['Vue.js', 'Laravel', 'TailwindCSS'],
    github: '#',
    demo: '#'
  },
  {
        ...
        <div class="text-center space-y-8">
          ...
          >
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              <span class="block text-foreground">Creative</span>
          ...
          >
            <p class="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              I craft exceptional digital experiences through innovative design and clean, efficient code.
            </p>
          </div>
          ...
          >
            ...
            <button class="inline-flex items-center gap-2 border border-border px-8 py-4 rounded-lg font-medium hover:bg-accent transition-all duration-200 hover:scale-105">
    ...
    <section class="py-20 bg-muted/30">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div class="flex items-center justify-center w-12 h-12 bg-primary/10 rounded-lg mb-6 group-hover:bg-primary/20 transition-colors duration-300">
